...
const chatSlice = createSlice({
    ...
    initialState: {
        departments: [],
        unreadCounts: {}, // { departmentId: count }
        chats: [],
        loading: false,
        error: null,
        sending: false,
    ...
    reducers: {
        incrementUnread: (state, action) => {
            ...
            state.unreadCounts[deptId] = (state.unreadCounts[deptId] || 0) + 1;
        },
...
export const { incrementUnread, clearUnread, updateUnreadCounts } = chatSlice.actions;
