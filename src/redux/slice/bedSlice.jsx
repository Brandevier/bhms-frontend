...
export const fetchBedsByDepartment = createAsyncThunk(
  ...
  async ({ departmentId, institution_id }, { rejectWithValue }) => {
    try {
      const response = await apiClient.get(`/beds/departments/${departmentId}/institution/${institution_id}/beds`); 
      // /departments/:departmentId/institution/:institution_id/beds
...
export const updateBedStatus = createAsyncThunk(
  ...
  async ({ bed_id, bed_number, department_id, institution_id, status }, { rejectWithValue }) => {
    try {
      const response = await apiClient.put('/beds/department/update-status', {
        bed_id,
        bed_number,
        department_id,
        institution_id,
