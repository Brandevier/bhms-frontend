...
const PatientRegistrationModal = ({ visible, onClose, onSubmit, status,loading }) => {
    ...
    >
      <Form layout="vertical" form={form}>
        ...
        <Row gutter={16}>
          ...
          <Col span={8}>
            <Form.Item name="has_insurance" valuePropName="checked">
              <Checkbox onChange={(e) => setHasInsurance(e.target.checked)}>Has Insurance</Checkbox>
            </Form.Item>
          </Col>
        </Row>
        ...
        {hasInsurance && (
          <Row gutter={16}>
            <Col span={8}>
              <Form.Item label="NHIS Number" name="nhis_number" rules={[{ required: true, message: "NHIS number is required" }]}>
